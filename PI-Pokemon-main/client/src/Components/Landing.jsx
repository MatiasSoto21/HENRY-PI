...
import pikachuimg from '../pngegg.png'
  ...
  return (
    <div className={s.container}>
      <div className={s.landing}>
        ...
        <div>
          <Link className={s.botonlink} to='/home'>Search and Create your Own Pokemon!✨
          </Link>
        </div>
        <img className={s.pikachu} src={pikachuimg} alt='pikachu'/>
      </div>
